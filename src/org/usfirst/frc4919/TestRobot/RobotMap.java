...
public class RobotMap {
    ...
    public static DigitalInput kickerBrakeRetracted;
    public static SpeedController towerPIDTowerMotor;
    public static AnalogPotentiometer towerPIDTowerSensor;
    ...
    public static void init() {
        ...
        kickerBrakeRetracted = new DigitalInput(0);
        LiveWindow.addSensor("Kicker", "Brake Retracted", kickerBrakeRetracted);
        
        towerPIDTowerMotor = new Talon(2);
        LiveWindow.addActuator("Tower PID", "Tower Motor", (Talon) towerPIDTowerMotor);
        
        towerPIDTowerSensor = new AnalogPotentiometer(1, 1.0, 0.0);
        LiveWindow.addSensor("Tower PID", "Tower Sensor", towerPIDTowerSensor);
